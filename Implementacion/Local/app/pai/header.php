            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        &nbsp;&nbsp;<h3 class="text-white">Revalida de Usuarios</h3>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                    </ul>
                    <form class="form-inline my-2 my-lg-0">
					<a class="boton_personalizado" href="permisos.php"><h6>PERMISOS</h6></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="boton_personalizado" href="buscarFormularios.php"><h6>FORMULARIOS</h6></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="boton_personalizado" href="../procesarLogout.php"><h6>SALIR</h6></a>
                </form>
                </div>
            </div>
        </div>
    </navbar>
	<body background="../../lib/img/fondoDifuminado.jpg">
