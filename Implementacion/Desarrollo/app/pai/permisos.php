            ...
            <br><div class="row">
                <div class="col">
                    <div class="text-center">
                        <h4 style="color:WHITE"><u>PERMISOS DE USUARIOS</u></h4>
                    </div>
                </div>
            </div>
            <br>
            <div id="centro" class="container">
                <form id="formBuscarEmpleado" name="formBuscarEmpleado" method="POST">
                    <div class="row">
						...
						<div class="col">
                            <label class="mr-sm-2" style="color:#fcfafa;">SISTEMA:</label> 
                            <select name="sistema" id="sistema" class="form-control mb-2" title="Estado">
							<?php
							$query = "SELECT id,nombre FROM [aplicativo]";
...
$(document).ready(function () {
    ...
    $("#contenido").on("click", "#btnBuscar", function () {
        $.ajax({
            type: "POST",
            url: "procesarBuscarPermisos.php",
